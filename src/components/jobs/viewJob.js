...
for (let post in postsFromUsers) {
	...
	render(){
		return(
			...
			<h3 className='text-center text-primary'>Members interested in this job:</h3>
			<table className="table">
				    ...
				    {this.state.postsFromUsers.map((post) => {
					    ...
					    <tr className='info' key={post.id}>
	                      ...
	                      <td><button className='btn-info btn btn-sm' onClick={this.handleShow}>View</button></td>
				...
				<Modal show={this.state.show} onHide={this.handleClose}>
		          ...
		          <Modal.Header closeButton>
		            <Modal.Title>Why this job is for me</Modal.Title>
		          </Modal.Header>
